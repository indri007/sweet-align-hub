...
export function Logo({ dark = false }: { dark?: boolean }) {
  return (
    <Link to="/" className="flex items-center gap-2.5">
      <div className="grid h-9 w-9 place-items-center rounded-xl bg-[#0A66C2] shadow-sm">
      ...
      >
        JobMatch<span className="text-[#0A66C2]">AI</span>
      </span>
    </Link>
  );
}
          ...
          {links.map((l) => {
            ...
            return (
              <Link
                key={l.to}
                to={l.to}
                className={`transition-colors ${active ? "text-[#0A66C2]" : "hover:text-[#0A66C2]"}`}
              >
                {l.label}
              </Link>
            );
...
function DashboardMock() {
  return (
    <div className="relative">
      <div className="absolute -inset-4 bg-gradient-to-tr from-[#0A66C2] to-[#34A853] opacity-20 blur-3xl rounded-full" />
        ...
        <div className="flex flex-col sm:flex-row gap-6 mb-8">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex-1">
            ...
            <div className="mt-4 h-2 w-full bg-slate-100 rounded-full overflow-hidden">
              <div className="h-full bg-[#0A66C2] rounded-full" style={{ width: "87%" }} />
            </div>
          </div>
...
export function Hero() {
  return (
    <section id="top" className="relative pt-14 pb-24 lg:pt-20 lg:pb-32 overflow-hidden">
      ...
      <div className="absolute -top-24 -left-24 w-96 h-96 bg-[#0A66C2]/5 rounded-full blur-3xl -z-10" />
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-5 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-6">
        <div>
          <Reveal>
            <div className="inline-flex items-center gap-2.5 rounded-full bg-[#0A66C2]/10 border border-[#0A66C2]/15 px-4 py-2 mb-5 sm:mb-6">
              ...
              <span className="text-xs sm:text-sm font-bold text-[#004182] uppercase tracking-wider">
          ...
          <Reveal delay={220}>
            <div className="mt-7 sm:mt-9 flex flex-col sm:flex-row gap-3 sm:items-center">
              <Link
                to="/generate"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#0A66C2] px-6 sm:px-8 py-3.5 sm:py-4 text-sm sm:text-base font-bold text-white shadow-lg shadow-[#0A66C2]/25 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#0A66C2]/30"
              >
        ...
        <Reveal delay={200}>
          <div className="relative">
            ...
            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl bg-gradient-to-br from-[#0A66C2] via-[#0A66C2] to-[#004182] p-4 sm:p-8 lg:p-10">
              {/* subtle dot grid */}
              <div
              ...
              <div className="relative mt-5 sm:mt-6">
                ...
                >
                  <svg className="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 48 48" aria-hidden="true">
                    ...
                    <path fill="#0A66C2" d="M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.51-4.18 7.09-10.36 7.09-17.65z"/>
  ...
  return (
    <section className="py-24 bg-slate-50 border-y border-slate-100">
      <div className="mx-auto max-w-4xl px-5 text-center lg:px-6">
        <Reveal>
          <span className="inline-block rounded-full bg-[#FF0000]/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[#FF0000]">
            Real Talk
          </span>
        </Reveal>
        <Reveal delay={80}>
          <h2 className="mt-5 font-display text-4xl md:text-5xl font-bold text-slate-900">
            75% of CVs Never Get{" "}
            <span className="text-[#0A66C2]">Read by a Human</span>
          </h2>
        </Reveal>
        <Reveal delay={140}>
          <p className="mt-6 text-lg md:text-xl leading-relaxed text-slate-600">
            ...
            <span className="text-[#FF0000] font-semibold">auto-rejected</span>, padahal
...
const FEATURES = [
  {
    ...
    color: "#0A66C2",
    bg: "bg-[#0A66C2]/10",
    hover: "hover:border-[#0A66C2]/30 hover:shadow-blue-500/10",
  ...
  },
  {
    ...
    color: "#FF0000",
    bg: "bg-[#FF0000]/10",
    hover: "hover:border-[#FF0000]/30 hover:shadow-red-500/10",
        ...
        <Reveal>
          <div className="text-center mb-16 lg:mb-20">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-slate-900">
              ...
              <span className="text-[#0A66C2]">land the interview</span>
            </h2>
    ...
    <section className="py-24 bg-white border-y border-slate-100">
      <div className="mx-auto max-w-7xl px-5 lg:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <Reveal>
              <span className="inline-block rounded-full bg-[#0A66C2]/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[#004182]">
            ...
            <Reveal delay={80}>
              <p className="mt-5 text-base sm:text-lg text-slate-600 leading-relaxed">
                Kebanyakan job seeker gak pernah tahu kenapa lamaran mereka <i className="text-slate-800 font-medium">silent</i> — CV yang keliatan bagus di mata manusia belum tentu kebaca dengan benar sama <i className="text-[#0A66C2] font-medium">system</i> yang dipakai perusahaan buat nyaring ratusan applicant sekaligus.
              </p>
            </Reveal>
            <Reveal delay={160}>
              <p className="mt-4 text-base sm:text-lg text-slate-600 leading-relaxed">
                JobMatch AI dibuat buat nutup gap itu. Kita analisis CV kamu persis kayak cara ATS beneran baca — kasih <i className="text-[#0A66C2] font-medium">score</i> yang objektif per kategori, terus <i className="text-[#0A66C2] font-medium">match</i> profil kamu secara <i className="text-[#0A66C2] font-medium">semantic</i> ke lowongan yang bener-bener relevan. Bukan cuma cocokin <i className="text-[#0A66C2] font-medium">keyword</i> doang, tapi paham makna di balik <i className="text-[#0A66C2] font-medium">experience</i> yang udah kamu bangun.
              </p>
            </Reveal>
            <Reveal delay={240}>
              <div className="mt-6 p-5 rounded-2xl bg-[#0A66C2]/5 border border-[#0A66C2]/10">
                <p className="text-base sm:text-lg font-semibold text-slate-900 leading-relaxed">
                  Intinya: kita bantu CV kamu ngomong bahasa yang dipahami <i className="text-[#0A66C2]">system</i>, biar effort kamu selama ini gak sia-sia cuma gara-gara format yang salah.
                </p>
              </div>
            </Reveal>
          </div>
          <Reveal delay={200}>
            <div className="relative flex justify-center lg:justify-end">
              <div className="absolute inset-0 bg-gradient-to-tr from-[#004182] to-[#0A66C2] opacity-10 blur-3xl rounded-full" />
              <div className="relative bg-white rounded-3xl border border-slate-100 shadow-xl p-8 max-w-md w-full">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col items-center justify-center p-6 bg-[#0A66C2]/10 border border-[#0A66C2]/20 rounded-2xl">
                    <Sparkles className="h-8 w-8 text-[#0A66C2] mb-3" />
                    <span className="text-xs font-bold text-[#004182] uppercase text-center">ATS View</span>
                  </div>
                </div>
                <div className="mt-6 flex items-center justify-center gap-3">
                  <ArrowRight className="h-5 w-5 text-slate-300" />
                  <div className="px-4 py-2 bg-[#34A853]/10 text-[#1b5e32] rounded-full text-sm font-bold">
                    Match Found 🎯
                  </div>
                </div>
              </div>
...
/* ---------- How it works ---------- */
const STEPS = [
  { icon: Upload, color: "#0A66C2", bg: "bg-[#0A66C2]/10", title: "Upload your CV", desc: "PDF atau foto — kita handle semua format." },
        ...
        <Reveal>
          <div className="text-center mb-16">
            ...
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-bold text-slate-900">
              3 steps, <span className="text-[#0A66C2]">no ribet</span>
            </h2>
          </div>
        </Reveal>
    ...
    <section id="generate" className="py-24 lg:py-32 bg-white">
      <div className="mx-auto max-w-7xl px-5 lg:px-6">
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center lg:gap-16">
          <div>
            <Reveal>
              <span className="inline-flex items-center gap-2 rounded-full bg-[#0A66C2]/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[#0A66C2]">
            ...
            <Reveal delay={80}>
              <h2 className="mt-5 font-display text-4xl md:text-5xl font-bold text-slate-900 leading-tight">
                {c.heading}
                <span className="text-[#0A66C2]">{c.headingAccent}</span>.
              </h2>
            </Reveal>
            <Reveal delay={140}>
              ...
              <div className="mt-6 max-w-md">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    className="flex-1 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0A66C2]/30 focus:border-[#0A66C2]"
                  />
                  <button className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#0A66C2] px-5 py-3 text-sm font-bold text-white shadow-lg shadow-[#0A66C2]/25 transition-all hover:-translate-y-0.5 hover:shadow-xl">
          ...
          <Reveal delay={200}>
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-tr from-[#0A66C2] to-[#FBBC05] opacity-15 blur-3xl rounded-full" />
              <div className="relative bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden">
                ...
                <div className="p-6 sm:p-8 text-slate-800">
                  <div className="pb-4 border-b border-slate-200">
                    ...
                    <div className="text-sm font-semibold text-[#0A66C2] mt-0.5">{p.title}</div>
                  ...
                  <div className="mt-5">
                    <div className="text-[10px] font-black uppercase tracking-widest text-[#0A66C2]">
                      {p.summaryLabel}
                    </div>
                  ...
                  <div className="mt-5">
                    <div className="text-[10px] font-black uppercase tracking-widest text-[#0A66C2] flex items-center gap-1.5">
                  ...
                  <div className="mt-5">
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      {p.skills.map((s) => (
                        <span
                          key={s}
                          className="rounded-full bg-[#0A66C2]/10 px-2.5 py-0.5 text-[11px] font-semibold text-[#0A66C2]"
                        >
                          {s}
                        </span>
                      ))}
        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center lg:gap-16">
          <Reveal>
            <div className="relative order-2 lg:order-1">
              <div className="absolute -inset-4 bg-gradient-to-tr from-[#34A853] to-[#0A66C2] opacity-15 blur-3xl rounded-full" />
              <div className="relative bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden">
                <div className="flex items-center justify-between px-5 py-3 border-b border-slate-100 bg-slate-50">
                  <div className="flex items-center gap-2">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="mt-5">
                    <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[#FF0000]">
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      {missing.map((k) => (
                        <span
                          key={k}
                          className="inline-flex items-center gap-1 rounded-full bg-[#FF0000]/10 px-2.5 py-0.5 text-[11px] font-semibold text-[#FF0000]"
                        >
                          {k}
                        </span>
                      ))}
                  ...
                  <div className="mt-6 grid grid-cols-3 gap-3">
                    {([
                      ["Skills", subScores.skills, "#0A66C2"],
          ...
          <div className="order-1 lg:order-2">
              ...
              <div className="mt-8 space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-6 py-3 text-sm font-bold text-slate-900 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md hover:border-[#0A66C2]"
                  >
            ...
            <Reveal delay={260}>
              <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-5">
                ...
                {status === "error" && (
                  <div className="mt-3 flex items-start gap-2 rounded-lg bg-[#FF0000]/10 px-3 py-2 text-xs font-semibold text-[#FF0000]">
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-6">
        <Reveal>
          <div className="text-center mb-16">
            ...
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-bold text-slate-900">
              Real people, <span className="text-[#0A66C2]">real offers</span>
            </h2>
          </div>
        </Reveal>
  ...
  return (
    <section className="py-24 px-5 lg:px-6 bg-white">
      <div className="mx-auto max-w-5xl bg-slate-900 rounded-[2rem] md:rounded-[3rem] p-10 md:p-20 text-center relative overflow-hidden shadow-2xl">
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#0A66C2] opacity-20 blur-[100px]" />
        ...
        <Reveal delay={140}>
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 relative">
            <Link
              to="/generate"
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#0A66C2] px-8 py-4 text-base font-bold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
            >
              Start Free Now
              <ArrowRight className="h-5 w-5" />
            </Link>
