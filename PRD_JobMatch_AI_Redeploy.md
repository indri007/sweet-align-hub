...
> Seluruh referensi ke akun/project GCP spesifik pada dokumen asli telah
> dihapus dari versi arsip ini.
...
Lihat `PRD_JobMatch_AI.md` untuk detail lengkap arsitektur final:
