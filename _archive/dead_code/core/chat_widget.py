...
def render_cs_chatbot(gemini_client, system_health_status: dict = None):
    ...
    img_path = Path(__file__).parent.parent / "assets" / "leonardo.jpg"
    img_b64 = ""
    if img_path.exists():
        ...
        with st.container():
            ...
            if img_b64:
                ...
                <div class="cs-header" style="display:flex;align-items:center;gap:12px;margin-bottom:16px;padding-bottom:12px;border-bottom:1px solid var(--md-outline);">
                    ...
                    <div>
                        <div style="font-weight:700;color:var(--md-on-surface);font-size:1.05rem;line-height:1.2;">Leonardo — Senior HRD</div>
